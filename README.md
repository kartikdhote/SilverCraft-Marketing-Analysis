# SilverCraft : Marketing Campaign Performance Analysis
...
Data Acquisition: The raw data was imported into Power BI, from CSV format.
...
Advanced Data Modeling: Creating and managing relationships, including the crucial Date Dimension Table.

Sophisticated DAX Calculations: Developing complex measures for KPIs, Month-over-Month changes, and ROAS.

Interactive Dashboard Creation: Designing and implementing the multi-page, interactive dashboard.

Data Transformation & Cleaning: Performing necessary data cleaning and shaping within Power Query.
...
Here are screenshots illustrating the key sections of the dashboard:

Overall Campaign Analysis
A high-level view showing aggregated metrics and channel-wise performance comparison across all campaigns.

Monthly Campaign Analysis
Tracking monthly trends and month-over-month changes for key performance indicators across channels, enabling time-series analysis.

Detailed Campaign Analysis
A granular table allowing drill-down into specific campaigns, ad types, and geographical locations for in-depth segment analysis.

(Note: Please replace YourUsername and YourRepositoryName with your actual GitHub username and repository name in the image links above. Ensure your screenshots are uploaded to an images folder within your repository.)

Project Structure
.
├── data/
│   └── silvercraft_campaign_data_cleaned.csv  # Cleaned dataset used for analysis (example)
├── dashboards/
│   └── Silvercraft_Campaign_Analysis.pbix     # Power BI project file
├── images/
│   ├── Overall_Campaign_Analysis.png          # Screenshot of overall dashboard
│   ├── Monthly_Campaign_Analysis.png          # Screenshot of monthly dashboard
│   └── Detailed_Campaign_Analysis.png         # Screenshot of detailed dashboard
├── reports/
│   └── Silvercraft_Campaign_Analysis_Report.pdf # (Optional) PDF of your findings/presentation
├── scripts/
│   └── data_preprocessing.sql                   # (Optional) SQL/Python scripts for data prep
